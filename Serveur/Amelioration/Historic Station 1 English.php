...
<html>
    <head>
        ...
        <title>Project Norway/Historic Station 1</title>
    </head>
   ...
   <div id="conteneur">
        <nav>
            ...
            <div class="w3-dropdown-hover">
                    <button class="w3-button w3-indigo w3-left-align" style="width:203%"><i class="fa fa-exclamation-triangle" style="font-size:20px;color:white">
                    </i> Security                                                             
                    </button>
        ...
        <section>
            <h1><i class="fa fa-bar-chart" style="font-size:50px;color:white"></i> Historic Station 1</h1>
        </section>
    </div>
 ...
 <element4>
                ...
                <div class="w3-dropdown-content w3-bar-block w3-gray w3-left-align" style="width:100%">
                    <a href="http://localhost/Norway/Historic Station 1 English.php" class="w3-bar-item w3-button"> English</a>
                    <a href="http://localhost/Norway/Historisk Stasjon 1 Norsk.php" class="w3-bar-item w3-button"> Norwegian</a>
                </div>
            </div> 
        </element4>
