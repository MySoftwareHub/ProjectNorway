...
<html>
    <head>
        ...
        <title>Projekt Norge/Sikkerhet Stasjon 1</title>
    </head>
   ...
   <div id="conteneur">
        ...
        <section>
            <h1><i class="fa fa-exclamation-triangle" style="font-size:50px;color:white"></i> Sikkerhet Stasjon 1</h1>
        </section>
    </div>
    ...
    <element4>
                ...
                <div class="w3-dropdown-content w3-bar-block w3-gray w3-left-align" style="width:100%">
                    <a href="http://localhost/Norway/Security Station 1 English.php" class="w3-bar-item w3-button"> Engelsk</a>
                    <a href="http://localhost/Norway/Sikkerhet Stasjon 1 Norsk.php" class="w3-bar-item w3-button"> Norsk</a>
                </div>
            </div> 
        </element4>
