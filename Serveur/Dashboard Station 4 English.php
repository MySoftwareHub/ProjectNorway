...
<html>
    <head>
        ...
        <title>Project Norway/Dashboard Station 4</title>
    </head>
   ...
   <div id="conteneur">
        ...
        <section>
            <h1><i class="fa fa-dashboard" style="font-size:50px;color:white"></i> Dashboard Station 4</h1>
        </section>
        ...
        <element3>
         ...
         <element4>
                ...
                <div class="w3-dropdown-content w3-bar-block w3-gray w3-left-align" style="width:100%">
                    <a href="http://localhost/Norway/Dashboard Station 4 English.php" class="w3-bar-item w3-button"> English</a>
                    <a href="http://localhost/Norway/Dashbord Stasjon 4 Norsk.php" class="w3-bar-item w3-button"> Norwegian</a>
                </div>
            </div> 
        </element4>
