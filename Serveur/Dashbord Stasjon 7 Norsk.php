...
<html>
    <head>
        ...
        <title>Prosjekt Norge/Dashbord Stasjon 7</title>
    </head>
   ...
   <div id="conteneur">
        ...
        <section>
            <h1><i class="fa fa-dashboard" style="font-size:50px;color:white"></i> Dashbord Stasjon 7</h1>
        </section>
  ...
  <element1>
                    ...
                    $result = $db->query('SELECT Luminosity FROM Data_Arduino WHERE Station = 7 ORDER BY id DESC LIMIT 1 ');
          ...
          <element2>
                    <?php  
                    $db = new SQLite3('Database.db');
                    $result = $db->query('SELECT Temperature FROM Data_Arduino WHERE Station = 7 ORDER BY id DESC LIMIT 1 ');
                    while ($row = $result->fetchArray())
                    {
                    ?>
        ...
        <element3>
         ...
         <element4>
                ...
                <div class="w3-dropdown-content w3-bar-block w3-gray w3-left-align" style="width:100%">
                    <a href="http://localhost/Norway/Dashboard Station 7 English.php" class="w3-bar-item w3-button"> Engelsk</a>
                    <a href="http://localhost/Norway/Dashbord Stasjon 7 Norsk.php" class="w3-bar-item w3-button"> Norsk</a>
                </div>
            </div> 
        </element4>
