...
<html>
    <head>
        ...
        <title>Project Norway/Administration</title>
    </head>
   ...
   <div id="conteneur">
       <nav>
        ...
        <section>
            <h1><i class="fa fa-wrench" style="font-size:50px;color:white"></i> Administration</h1>
        </section>
    </div>
    ...
    <element3>
     ...
     <element4>
                ...
                <div class="w3-dropdown-content w3-bar-block w3-gray w3-left-align" style="width:100%">
                    <a href="http://localhost/Norway/Administration English.php" class="w3-bar-item w3-button"> English</a>
                    <a href="http://localhost/Norway/Administrasjon Norsk.php" class="w3-bar-item w3-button"> Norwegian</a>
                </div>
            </div> 
        </element4>

<element10>
                <p>The system uses these components :</p>
                <p>- Lorawan</p>
                <p>- Arduino</p>
                <p>- Raspberry Pi</p>
                <p>- Apache 2 Server</p>
                ...
                <p>- Python</p>
                <p>- SQL</p>
                <p>- Web languages (PHP, HTML5, CSS3 and Javascript)</p>
</element10>


<element11>
	<p1>Download all programs :</p>
</element11>

<element12>
	<a href="http://localhost/Norway/Download English.php" class="w3-button w3-block w3-gray w3-left-align" style="width:55%"><i class="fa fa-download" style="font-size:20px;color:black"></i> Download</a>
</element12>
