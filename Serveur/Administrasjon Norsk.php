...
<html>
    <head>
        ...
        <title>Projekt Norge/Administrasjon</title>
    </head>
   ...
   <div id="conteneur">
       <nav>
        ...
        <section>
            <h1><i class="fa fa-wrench" style="font-size:50px;color:white"></i> Administrasjon</h1>
        </section>
    </div>
    ...
    <element3>
     ...
     <element4>
                ...
                <div class="w3-dropdown-content w3-bar-block w3-gray w3-left-align" style="width:100%">
                    <a href="http://localhost/Norway/Administration English.php" class="w3-bar-item w3-button"> Engelsk</a>
                    <a href="http://localhost/Norway/Administrasjon Norsk.php" class="w3-bar-item w3-button"> Norsk</a>
                </div>
            </div> 
        </element4>
...
<element14>
                <p>Systemet bruk disse komponenter :</p>
                <p>- Lorawan</p>
                <p>- Arduino</p>
                <p>- Raspberry Pi</p>
                <p>- Apache 2 Server</p>
                ...
                <p>- Python</p>
                <p>- SQL</p>
                <p>- Web språk (PHP, HTML5, CSS3 og Javascript)</p>
</element14>


<element15>
    <p>Neslasting alle programmene :</p>
</element15>

<element16>
    <a href="http://localhost/Norway/Nedlasting Norsk.php" class="w3-button w3-block w3-gray w3-left-align" style="width:55%"><i class="fa fa-download" style="font-size:20px;color:black"></i> Neslasting</a>
</element16>
