...
<html>
    <head>
        ...
        <title>Project Norway/Security Station 6</title>
    </head>
   ...
   <div id="conteneur">
        ...
        <section>
            <h1><i class="fa fa-exclamation-triangle" style="font-size:50px;color:white"></i> Security Station 6</h1>
        </section>
    </div>
    ...
    <element3>
         ...
         <element4>
                ...
                <div class="w3-dropdown-content w3-bar-block w3-gray w3-left-align" style="width:100%">
                    <a href="http://localhost/Norway/Security Station 6 English.php" class="w3-bar-item w3-button"> English</a>
                    <a href="http://localhost/Norway/Sikkerhet Stasjon 6 Norsk.php" class="w3-bar-item w3-button"> Norwegian</a>
                </div>
            </div> 
        </element4>
      ...
      <element8>
                    ...
                    $result = $db->query('SELECT Battery_Loading FROM Data_Arduino WHERE Station = 6 ORDER BY id DESC LIMIT 1 ');
      ...
      <element9>
                    <?php  
                    $db = new SQLite3('Database.db');
                    $result = $db->query('SELECT Internal_Temperature FROM Data_Arduino WHERE Station = 6 ORDER BY id DESC LIMIT 1 ');
                    while ($row = $result->fetchArray())
                    {
                    ?>
