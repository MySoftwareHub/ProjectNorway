...
echo '
<p>
        Nedlasting den posten : <a href="?file=' . $name . '">Direkt nedlasting</a>
</p>
...
<element13>
        <a href="http://localhost/Norway/Administrasjon Norsk.php" class="w3-button w3-block w3-gray w3-left-align" style="width:55%"><i class="fa fa-reply" style="font-size:20px;color:black"></i> Retur</a>
</element13>
